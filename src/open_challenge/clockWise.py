...
LEFT_TARGET = 0.60        # m: desired left-wall distance
...
# Left ROI is kept low and near the left edge so it measures the side wall.
LEFT_ROI = (0.04, 0.28, 0.42, 0.82)
...
def main() -> None:
    ...
    try:
        while running:
            ...
            left_distance = roi_distance(depth_m, LEFT_ROI)
            ...
            if turning_right:
                ...
                if np.isfinite(left_distance):
                    ...
                    error = LEFT_TARGET - left_distance
                    ...
                    # Search gently toward the missing left wall.
